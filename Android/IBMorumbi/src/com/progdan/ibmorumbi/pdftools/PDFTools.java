package com.progdan.ibmorumbi.pdftools;

import java.io.File;

import com.progdan.ibmorumbi.R;
...
/**
 * The main method for the code is:<br />
 * PDFTools.showPDFUrl(Context context, String pdfUrl);
 * 
 * @author progdan
 * 
 */
public class PDFTools {
	...
	public static void downloadAndOpenPDF(final Context context,
			final String pdfUrl) {
		// Get filename
	 ...
	 * @param pdfUrl
	 */
	public static void askToOpenPDFThroughGoogleDrive(final Context context,
			final String pdfUrl) {
		new AlertDialog.Builder(context)
				.setTitle(R.string.pdf_show_online_dialog_title)
				.setMessage(R.string.pdf_show_online_dialog_question)
				.setNegativeButton(R.string.pdf_show_online_dialog_button_no,
						null)
				.setPositiveButton(R.string.pdf_show_online_dialog_button_yes,
						new OnClickListener() {
							@Override
