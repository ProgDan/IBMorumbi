...
package com.progdan.ibmorumbitv.keyboard;
...
public class InputExtras
{
    ...
    public static final String KEY_BACK_LABEL = "backLabel";
    public static final String KEY_NEXT_LABEL = "nextLabel";
    ...
    public static final String KEY_TYPE_CREDIT_CARD = "card";
